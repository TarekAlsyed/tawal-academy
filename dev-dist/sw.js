...
define(['./workbox-21a80088'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    "url": "/tawal-academy/index.html",
    "revision": "0.380q7bsvkak"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("/tawal-academy/index.html"), {
    allowlist: [/^\/$/]
  }));
  ...
  workbox.registerRoute(/.*\/api\/subjects\/.*\/pdfs\/.*\/download/i, new workbox.NetworkFirst({
